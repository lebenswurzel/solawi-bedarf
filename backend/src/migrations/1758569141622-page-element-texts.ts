...
export class PageElementTexts1758569141622 implements MigrationInterface {
  name = "PageElementTexts1758569141622";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."text_content_category_enum" AS ENUM('IMPRINT', 'PRIVACY_NOTICE', 'FAQ', 'TAC', 'MAINTENANCE_MESSAGE', 'ORGANIZATION_INFO', 'PDF', 'EMAIL', 'PAGE_ELEMENTS')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."text_content_category_enum_old" AS ENUM('IMPRINT', 'PRIVACY_NOTICE', 'FAQ', 'TAC', 'MAINTENANCE_MESSAGE', 'ORGANIZATION_INFO', 'PDF', 'EMAIL')`,
    );
    await queryRunner.query(
