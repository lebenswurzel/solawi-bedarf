...
export class EmailTexts1757146546682 implements MigrationInterface {
  name = "EmailTexts1757146546682";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."text_content_category_enum" AS ENUM('IMPRINT', 'PRIVACY_NOTICE', 'FAQ', 'TAC', 'MAINTENANCE_MESSAGE', 'ORGANIZATION_INFO', 'PDF', 'EMAIL')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."text_content_category_enum_old" AS ENUM('IMPRINT', 'PRIVACY_NOTICE', 'FAQ', 'TAC', 'MAINTENANCE_MESSAGE', 'ORGANIZATION_INFO', 'PDF')`,
    );
    await queryRunner.query(
